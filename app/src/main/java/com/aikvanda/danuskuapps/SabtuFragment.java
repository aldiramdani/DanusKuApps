...
public class SabtuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_sabtu, container, false);
    ...
    private void display() {
        array = new ArrayList<>();
        array = getData();
        final ListView listdata = (ListView) v.findViewById(R.id.listdatasabtu);
    ...
    public List<data> getData() {
        ...
        try {
            String query = "select * from "+tabeldb.listtabeldb.TABLE_DATA+" where "+tabeldb.listtabeldb.HARI+" = 'Sabtu'";
